        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="sage-rule mt-8" />
            </div>

            <div className="prose prose-sage font-body text-charcoal/80 leading-relaxed space-y-12">
              ...
              <section className="space-y-6">
                ...
                <p>
                  To exercise these rights, contact us at <a href="mailto:info@bridalcourtyard.com" className="text-sage hover:underline">info@bridalcourtyard.com</a>.
                </p>
                <p>
                  If you are unhappy with how we use your data, you can also complain to the UK Information Commissioner’s Office (ICO) at <a href="https://www.ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-sage hover:underline">www.ico.org.uk</a>.
                </p>
              </section>

              <section id="cookies" className="space-y-6 pt-12 border-t border-gray-100">
                <h2 className="font-display text-3xl md:text-4xl text-charcoal text-sage">Cookies</h2>
              ...
              <section className="space-y-6">
                ...
                <p>
                  If you have any questions about this policy, please contact us at <a href="mailto:info@bridalcourtyard.com" className="text-sage hover:underline">info@bridalcourtyard.com</a>.
                </p>
              </section>
