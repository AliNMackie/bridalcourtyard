    ...
    <div className="pt-20">
      <Section className="bg-white py-24 md:py-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-16 md:gap-24 items-start">
          ...
          >
            <div className="space-y-6">
              <div className="space-y-2">
                <Link href="/designers" className="font-body text-[10px] uppercase tracking-[0.3em] text-sage hover:text-charcoal transition-colors flex items-center gap-2 mb-8">
                  &larr; All Designers
                </Link>
          ...
          >
            <div className="relative aspect-[3/4] bg-sage-light overflow-hidden shadow-2xl">
              <Image
                src={image}
