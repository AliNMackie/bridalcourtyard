      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 space-y-16">
        {reviews.map((review, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="space-y-6 border-l-2 border-luxury-gold/30 pl-8 md:pl-12 py-4"
          >
            <p className="font-body text-xl md:text-2xl text-charcoal leading-relaxed italic">
              &quot;{review.text}&quot;
            </p>
            <p className="font-body text-[13px] uppercase tracking-[0.25em] text-luxury-gold font-medium">
              &mdash; {review.author}
            </p>
          </motion.div>
        ))}
