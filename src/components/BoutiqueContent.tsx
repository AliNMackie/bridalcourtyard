      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="relative aspect-[3/4] bg-sage-light overflow-hidden shadow-2xl"
          >
            <Image 
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-8 pt-6">
              <div className="space-y-2">
                <span className="font-display text-3xl text-sage">Private</span>
                <p className="font-body text-xs uppercase tracking-widest text-charcoal/50">Consultations</p>
              </div>
              <div className="space-y-2">
                <span className="font-display text-3xl text-sage">Exclusive</span>
